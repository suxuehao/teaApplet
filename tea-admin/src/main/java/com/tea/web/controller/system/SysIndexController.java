...
import com.tea.common.utils.CookieUtils;
...
public class SysIndexController extends BaseController {
    ...
    public String main(ModelMap mmap) {
        mmap.put("dealerShopAndPicture",dealerShopService.selectDealerShopAndPictureList(new DealerShop()));
        mmap.put("version", RuoYiConfig.getVersion());
        mmap.put("user", getSysUser());
        mmap.put("officeUrl",officeUrl);
        return "main";
    }
