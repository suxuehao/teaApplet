...
import com.tea.common.json.JSON;
...
public class LogUtils {
    ...
    public static void logAccess(HttpServletRequest request) throws Exception {
        ...
        String ip = com.tea.common.utils.IpUtils.getIpAddr(request);
    ...
    public static void logPageError(HttpServletRequest request) {
        ...
        s.append(getBlock(message));
        s.append(getBlock(com.tea.common.utils.IpUtils.getIpAddr(request)));
